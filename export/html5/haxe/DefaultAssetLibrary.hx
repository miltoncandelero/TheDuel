...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/preloader/logo.png", __ASSET__assets_preloader_logo_png);
		type.set ("assets/preloader/logo.png", AssetType.IMAGE);
...
@:keep @:bind #if display private #end class __ASSET__assets_preloader_logo_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/preloader/logo.png") #if display private #end class __ASSET__assets_preloader_logo_png extends lime.graphics.Image {}
