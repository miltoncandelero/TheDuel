...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed (projectName, null, 512, 288, config);
		#end
		#else
		create (config);
		#end
	...
	#if (openfl < "5.0.0")
	#if (js && html5)
	@:keep @:expose("TheDuelOpenFL.embed")
	public static function _embed (element:Dynamic, width:Null<Int> = null, height:Null<Int> = null, background:String = null, assetsPrefix:String = null) {
		...
		lime.system.System.embed ("TheDuelOpenFL", element, width, height, { background: background, assetsPrefix: assetsPrefix });
